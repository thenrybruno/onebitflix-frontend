        ...
        <>
            <Container className={styles.nav}>
                ...
                <div className='d-flex align-items-center'>
                    ...
                    <img src="./homeAuth/iconSearch.svg" alt="Lupa" className={styles.searchImg} />
                    <p className={styles.userProfile} onClick={handleOpenModal}>AB</p>
                </div>
                <Modal isOpen={modalOpen} onRequestClose={handleCloseModal} shouldCloseOnEsc={true} className={styles.modal} 
