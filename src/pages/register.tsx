            ...
            <main className={styles.main}>
                ...
                <Container className='py-5'>
                    ...
                    <Form className={styles.form}>
                        ...
                        <FormGroup>
                            <Label for='lasttName' className={styles.label}>SOBRENOME</Label>
                            <Input id='lasttName' name='lasttName' type='text' placeholder='Qual é o seu sobrenome?' required maxLength={20} className={styles.inputName}/>
                        </FormGroup>
                        <FormGroup>
                        ...
                        <FormGroup>
                            ...
                            <Input id='email' name='email' type='email' placeholder='Informe seu e-mail.' required className={styles.input}/>
                        </FormGroup>
                        <FormGroup>
                            <Label for='birth' className={styles.label}>DATA DE NASCIMENTO</Label>
                            <Input id='birth' name='birth' type='date' min='1930-01-01' max='2013-12-31' required className={styles.input}/>
                        </FormGroup>
                        <FormGroup>
